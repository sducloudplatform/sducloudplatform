...
CREATE TABLE `admin_info`  (
  ...
  CONSTRAINT `admin_info_ibfk_1` FOREIGN KEY (`relation_uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `default_requirement`  (
  ...
  CONSTRAINT `default_requirement_ibfk_2` FOREIGN KEY (`relation_doctorid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `doc_org_relation`  (
  ...
  CONSTRAINT `doc_org_relation_ibfk_1` FOREIGN KEY (`doctor_uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `doctor_info`  (
  ...
  INDEX `relation_uid`(`relation_uid`) USING BTREE,
  INDEX `relation_groupid`(`relation_groupid`) USING BTREE,
  CONSTRAINT `doctor_info_ibfk_1` FOREIGN KEY (`relation_uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `employee_info`  (
  ...
  INDEX `relation_uid`(`relation_uid`) USING BTREE,
  INDEX `relation_groupid`(`relation_groupid`) USING BTREE,
  CONSTRAINT `employee_info_ibfk_1` FOREIGN KEY (`relation_uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `order`  (
  ...
  INDEX `relation_orgid`(`relation_orgid`) USING BTREE,
  INDEX `doctor_uid`(`doctor_uid`) USING BTREE,
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`petient_uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`relation_orgid`) REFERENCES `organization` (`orgid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `order_ibfk_3` FOREIGN KEY (`doctor_uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `patient_info`  (
  ...
  INDEX `relation_groupid`(`relation_groupid`) USING BTREE,
  INDEX `relation_orgid`(`relation_orgid`) USING BTREE,
  CONSTRAINT `patient_info_ibfk_1` FOREIGN KEY (`relation_uid`) REFERENCES `user` (`uid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
